...
Scraping_execution.py  is the execution file for scraping, we import above scarping module and execuate our scraping.The two datasets that are required for running this script are in the folder Dataset Project.zip 
